...
# Icon
root.iconbitmap(r"D:\CollegeWorks\Python\MusicPlayer\Music\asset\musicIcon.ico")
# initialize mixer
mixer.init()

# create the listbox to contain songs
songs_list = Listbox(root, selectmode=SINGLE, bg="white", fg="black", font=('arial', 15), height=12, width=47,
