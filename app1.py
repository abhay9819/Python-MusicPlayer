...
class Login():
    ...
    def create_elements(self):
        ...
        self.username = Label(self.root, text="Username:", font=('Arial', 14, 'bold'))
        self.username.place(x=50, y=50)

        self.entry_username = Entry(self.root, font=('Arial', 14))
        self.entry_username.place(x=160, y=50)

        self.password = Label(self.root, text="Password:", font=('Arial', 14, 'bold'))
        self.password.place(x=50, y=90)

        self.entry_password = Entry(self.root, font=('Arial', 14))
        ...
        self.new_user = Label(self.root, text="New User?", font=('Arial', 10, 'bold'))
        self.new_user.place(x=250, y=140)

        self.register_button = Button(self.root, text="Sign Up", height=2, width=10, command=self.destroy_login)
        self.register_button.place(x=250, y=160)
...
class Register():
    ...
    def create_elements(self):
        ...
        self.name = Label(self.root, text="Name:", font=('Arial', 14, 'bold'))
        self.name.place(x=50, y=130)

        self.entry_name = Entry(self.root, font=('Arial', 14))
        ...
        self.existing_user = Label(self.root, text="Existing User?", font=('Arial', 10, 'bold'))
